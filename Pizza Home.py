stocks=[["Margherita Pizza",10,99],["Farmhouse Pizza",10,199],["Veg Extravaganza Pizza",10,399],["Tomato Pasta Pizza",10,499],["Combo(Margherita,Farmhouse)",10,521],["Soft Drink(200 ml Coke)",100,25]]
AdminID = "Admin"
                        ...
                        while t==0:
                            ...
                            if (a <=len(stocks)):
                                if (stocks[a][1] > b):
                                    ...
                                    print("\n\n",stocks[a][0], "is out of Stock . Order Quantity can be", stocks[a][1],
                                          "or less")
                                    break
                            else:
